...
class AccountLVL4 extends Model
{
    //
    protected $guarded = [];
    protected $table ='accounts_lvl_4';
    ...
    public function transactions(){
        return $this->belongsToMany(Transaction::class,'account_transaction','fourth_level_account_id','transaction_id')
    ...
    public function scopeWithAccountStatementsSum($query,$TransactionsID){
        ...
        $query->addSelect(['CurrentYearSum' => function ($query) use ($TransactionsID) {
            ...
            $query->selectRaw('sum(current_year)')
                ...
                ->whereColumn('fourth_level_account_id', 'accounts_lvl_4.id');
        }]);
