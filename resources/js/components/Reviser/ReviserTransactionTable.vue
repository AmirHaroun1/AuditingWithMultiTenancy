<template>
    <div class="box" style="padding-top: 20px">
        ...
        <div class="box-header" style="padding-top:30px">
            <div class="row">
                <div class="col-md-3">
                    <h3 class="header">جدول معاملات المراجع</h3>
                </div>
                <div class="col-md-5 ">
        ...
        <div class="box-body table-responsive no-padding">
            ...
            <table class="table table-hover">
                ...
                <tr v-if="SearchedTransactions.length" v-for="transaction in SearchedTransactions">
                    <td><a :href="route('transactions.edit.reviser',transaction.id)"> {{transaction.MainTradeRegisterNumber}}</a></td>
