        ...
        <v-card class="row">
            ...
            <v-card-text class="box-body" id="printHeading">
                <div v-if="Accounts.length">
                    <div
                        v-for="FirstLVLAccount in Accounts"
                        :key="FirstLVLAccount.id"
                    >
                            ...
                            <v-card
                                ...
                                @click="
                                    FirstLVLAccount.MonetaryItems
                                        ? ''
                                        : GetAccountStatements(FirstLVLAccount)
                                "
        ...
        SetClearanceNumber() {
            ...
            this.Accounts.forEach(FirstLVLAccount => {
                if (
                    ...
                    console.log(
                        FirstLVLAccount.name + FirstLVLAccount.CurrentYearSum
                    );
        ...
        GetFourthLevelAccountValues(Account, ParentThirdLVLAccount) {
            ...
            axios
                ...
                .then(({ data }) => {
                    ...
                    ParentThirdLVLAccount.CurrentYearSum += parseInt(
                        Account.CurrentYearSum ? Account.CurrentYearSum : 0
                    );
                    ParentThirdLVLAccount.CurrentYearDebtorSum += parseInt(
                        Account.CurrentYearDebtorSum
                            ? Account.CurrentYearDebtorSum
                            : 0
                    );
                    ParentThirdLVLAccount.CurrentYearCreditorSum += parseInt(
                        Account.CurrentYearCreditorSum
                            ? Account.CurrentYearCreditorSum
                            : 0
                    );
                    ParentThirdLVLAccount.edited_CurrentYearDebtorSum += parseInt(
                        Account.edited_CurrentYearDebtorSum
                            ? Account.edited_CurrentYearDebtorSum
                            : 0
                    );
                    ParentThirdLVLAccount.edited_CurrentYearCreditorSum += parseInt(
                        Account.edited_CurrentYearCreditorSum
                            ? Account.edited_CurrentYearCreditorSum
                            : 0
                    );
                    this.LoadingSpinner = false;
        ...
        GetFourthLevelAccountsStatementsOfThirdLevelAccount(ThirdLVLAccount) {
            ...
            ThirdLVLAccount.fourth_level_accounts.forEach(FourthLVLAccount => {
                if (!FourthLVLAccount.MonetaryItems) {
                    this.GetFourthLevelAccountValues(
                        FourthLVLAccount,
                        ThirdLVLAccount
                    );
                }
